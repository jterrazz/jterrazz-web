...
This code describes the _what_ without dictating the _how_. It defines the interface and the expected state change.

You can then instruct the agent: _"Implement the logic to make this test pass, following our existing patterns for controllers and services."_
...
_Next: We explore autonomous systems, where we move from directing agents in real-time to designing autonomous systems that work in the background._
