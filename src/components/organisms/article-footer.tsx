                ...
                <div className="relative z-10 flex flex-col gap-8">
                    ...
                    <div className="flex flex-wrap gap-6 text-sm text-zinc-500 dark:text-zinc-400 pb-8 border-b border-zinc-200 dark:border-zinc-800/50">
                        <div className="flex items-center gap-2">
                            ...
                            <span>Published on {new Date(datePublished).toLocaleDateString()}</span>
                        </div>
                        {dateModified !== datePublished && (
                            <div className="flex items-center gap-2">
                                <Clock className="w-4 h-4 text-zinc-400" />
                                <span>Updated on {new Date(dateModified).toLocaleDateString()}</span>
                            </div>
                        )}
                        <div className="flex items-center gap-2">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center gap-6 md:gap-8">
                        ...
                        <div className="flex-1 flex flex-col gap-3">
                            ...
                            <p className="text-sm leading-relaxed text-zinc-600 dark:text-zinc-300 max-w-2xl">
                                Focusing on clean architecture, AI agents, and building resilient
                                systems. I write about what I learn as I build software.
                            </p>
                        </div>
                    </div>
                </div>
