...
describe('capitalizeFirst', () => {
    ...
    test('should return an empty string when capitalizing nothing', () => {
...
describe('sanitizeEmDashes', () => {
    ...
    test('should return an empty string when there are no em dashes', () => {
        // Given - an empty string
        const input = '';
...
describe('sanitizeTitle', () => {
    ...
    test('should return an empty string when there is no title', () => {
        // Given - an empty string
        const input = '';
...
describe('sanitizeContent', () => {
    ...
    test('should return an empty string when there is no content', () => {
        // Given - an empty string
        const input = '';
