...
const ARTICLES_CONFIG: ArticleConfig[] = [
    {
        ...
        metadata: {
            ...
            description: {
                en: 'Build your own malloc in C from scratch. Learn mmap, memory buckets, first-fit allocation, block coalescing, and alignment to truly understand dynamic memory.',
                fr: "Codez votre propre malloc en C. Apprenez mmap, les buckets mémoire, l'allocation first-fit, la coalescence et l'alignement pour vraiment comprendre la mémoire dynamique.",
            },
            tagline: {
            ...
            title: {
                en: 'Writing your own malloc in C: a memory allocator from scratch',
                fr: 'Coder son propre malloc en C : un allocateur mémoire de zéro',
            },
        },
    ...
    },
    {
        ...
        metadata: {
            ...
            title: {
                en: 'SHA-256 and MD5 in C: implementing hash functions from scratch',
                fr: 'SHA-256 et MD5 en C : implémenter des fonctions de hachage de zéro',
            },
        },
        previewImage: DEFAULT_PREVIEW_IMAGE,
        publicIndex: 2,
    ...
    },
    {
        ...
        metadata: {
            ...
            title: {
                en: 'Building nm and otool: parsing Mach-O binaries in C',
                fr: 'Reconstruire nm et otool : parser les binaires Mach-O en C',
            },
        },
        previewImage: DEFAULT_PREVIEW_IMAGE,
        publicIndex: 3,
    ...
    },
    {
        ...
        metadata: {
            ...
            title: {
                en: 'x86-64 assembly basics: writing your first functions',
                fr: "Les bases de l'assembleur x86-64 : écrire ses premières fonctions",
            },
        },
        previewImage: DEFAULT_PREVIEW_IMAGE,
        publicIndex: 5,
    ...
    },
    {
        ...
        metadata: {
            ...
            title: {
                en: 'Building an expert system in Python (backward chaining)',
                fr: 'Construire un système expert en Python (chaînage arrière)',
            },
        },
        previewImage: DEFAULT_PREVIEW_IMAGE,
        publicIndex: 6,
    ...
    },
    {
        ...
        metadata: {
            ...
            title: {
                en: 'Building a web server with TypeScript and Koa',
                fr: 'Créer un serveur web avec TypeScript et Koa',
            },
        },
        previewImage: DEFAULT_PREVIEW_IMAGE,
        publicIndex: 7,
    ...
    },
    {
        ...
        metadata: {
            ...
            title: {
                en: 'Maintainable software: building applications that last',
                fr: 'Logiciel maintenable : bâtir des applications qui durent',
            },
        },
        previewImage: DEFAULT_PREVIEW_IMAGE,
        publicIndex: 9,
    ...
    },
    {
        ...
        metadata: {
            ...
            title: {
                en: 'The dependency rule: structuring code for independence',
                fr: "La règle des dépendances : structurer le code pour l'indépendance",
            },
        },
        previewImage: DEFAULT_PREVIEW_IMAGE,
        publicIndex: 10,
    ...
    },
    {
        ...
        metadata: {
            ...
            title: {
                en: 'Hexagonal architecture: separating business from technology',
                fr: 'Architecture hexagonale : séparer le métier de la technologie',
            },
        },
        previewImage: DEFAULT_PREVIEW_IMAGE,
        publicIndex: 11,
    ...
    },
    {
        ...
        metadata: {
            ...
            title: {
                en: 'Clean architecture in practice: entities, use cases, and layers',
                fr: "La Clean Architecture en pratique : entités, cas d'usage et couches",
            },
        },
        previewImage: DEFAULT_PREVIEW_IMAGE,
        publicIndex: 12,
    ...
    },
    {
        ...
        metadata: {
            ...
            description: {
                en: 'SigNews, a dashboard concept for monitoring global news narratives. AI distills signal from noise, mapping where stories align, clash, and fade into speculation.',
                fr: "SigNews, un concept de tableau de bord pour suivre l'évolution des récits mondiaux. L'IA extrait le signal du bruit, cartographiant où les histoires s'alignent et s'opposent.",
            },
            tagline: {
            ...
            title: {
                en: 'SigNews: mapping global news narratives with AI',
                fr: "SigNews : cartographier les récits mondiaux avec l'IA",
            },
        },
        previewImage: DEFAULT_PREVIEW_IMAGE,
        publicIndex: 13,
    ...
    },
    {
        ...
        metadata: {
            ...
            title: {
                en: 'Your moat is melting: what AI does to knowledge work',
                fr: "Votre forteresse s'effondre : ce que l'IA fait au travail du savoir",
            },
        },
        previewImage: DEFAULT_PREVIEW_IMAGE,
        publicIndex: 14,
    ...
    },
    {
        ...
        metadata: {
            ...
            title: {
                en: 'The collapse of the middle: where value goes when AI executes',
                fr: "L'effondrement du centre : où va la valeur quand l'IA exécute",
            },
        },
        previewImage: DEFAULT_PREVIEW_IMAGE,
        publicIndex: 16,
    ...
    },
    {
        ...
        metadata: {
            ...
            title: {
                en: 'Cursor IDE in practice: agent mode and intent-driven coding',
                fr: "Cursor IDE en pratique : mode agent et développement piloté par l'intention",
            },
        },
        previewImage: DEFAULT_PREVIEW_IMAGE,
        publicIndex: 19,
    ...
    },
    {
        ...
        metadata: {
            ...
            title: {
                en: 'Directing AI agents: from writing code to orchestrating it',
                fr: "Diriger les agents IA : de l'écriture du code à l'orchestration",
            },
        },
        previewImage: 'thumbnail.jpg',
        publicIndex: 21,
    ...
    },
    {
        ...
        metadata: {
            ...
            title: {
                en: 'Autonomous AI agents: when to delegate entire workflows',
                fr: 'Agents IA autonomes : quand déléguer des workflows entiers',
            },
        },
        previewImage: 'thumbnail.jpg',
        publicIndex: 22,
    ...
    },
    {
        ...
        metadata: {
            ...
            title: {
                en: 'When AI becomes the product: designing AI-native systems',
                fr: "Quand l'IA devient le produit : concevoir des systèmes natifs IA",
            },
        },
        previewImage: 'thumbnail.jpg',
        publicIndex: 23,
