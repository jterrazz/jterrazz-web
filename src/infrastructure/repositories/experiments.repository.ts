...
const experiments: Experiment[] = [
    {
        ...
        description: 'The operating system for autonomous agent worlds. Compose, spawn, ship.',
    ...
    },
    {
        ...
        components: [
            {
                architectures: [],
                description: 'Core engine (Rust).',
                name: 'Core',
                sourceUrl: new URL(`${REPOSITORY_BASE_URL}photopack`),
                status: ExperimentStatus.Building,
            },
            {
                architectures: [],
                ...
                isPrivate: true,
                name: 'macOS',
                sourceUrl: new URL(`${REPOSITORY_BASE_URL}photopack-macos`),
                status: ExperimentStatus.Building,
            },
            {
                architectures: [],
                ...
                isPrivate: true,
                name: 'Blueprint',
                sourceUrl: new URL(`${REPOSITORY_BASE_URL}photopack-blueprint`),
                status: ExperimentStatus.Building,
            },
        ],
        context: ExperimentContext.Personal,
    ...
    },
    {
        ...
        components: [
            ...
            },
            {
                ...
                isPrivate: true,
                name: 'Blueprint',
                sourceUrl: new URL(`${REPOSITORY_BASE_URL}clawssify-blueprint`),
                status: ExperimentStatus.Building,
            },
        ],
        context: ExperimentContext.Personal,
    ...
    },
    {
        ...
        components: [
            ...
            },
            {
                ...
                isPrivate: true,
                name: 'Web Landing',
                sourceUrl: new URL('https://github.com/clawrr/web-landing'),
                status: ExperimentStatus.Building,
            },
            {
                architectures: [],
            ...
            {
                architectures: [],
                description: 'HIRE protocol specification.',
                isPrivate: true,
                name: 'HIRE Protocol',
        ...
        context: ExperimentContext.Personal,
        description: 'AI agent marketplace — registry, discovery, and reputation.',
        ...
        components: [
            {
                ...
                isPrivate: true,
                name: 'API',
                sourceUrl: new URL(`${REPOSITORY_BASE_URL}signews-api`),
            ...
            },
            {
                ...
                isPrivate: true,
                name: 'Mobile',
                sourceUrl: new URL(`${REPOSITORY_BASE_URL}signews-mobile`),
                status: ExperimentStatus.Active,
            },
            {
                architectures: [],
                description: 'Broadcasts top events to Apple App Store.',
                isPrivate: true,
                name: 'Broadcast',
                sourceUrl: new URL(`${REPOSITORY_BASE_URL}signews-broadcast`),
                status: ExperimentStatus.Active,
            },
        ],
        context: ExperimentContext.Personal,
    ...
    },
    {
        ...
        components: [
            ...
            },
            {
                ...
                name: 'Codestyle',
                sourceUrl: new URL(`${REPOSITORY_BASE_URL}package-codestyle`),
                status: ExperimentStatus.Active,
            },
            {
                architectures: [],
            ...
            {
                architectures: [],
                description: 'Multi-channel broadcast system for app announcements.',
                name: 'Broadcast',
                sourceUrl: new URL(`${REPOSITORY_BASE_URL}package-broadcast`),
                status: ExperimentStatus.Active,
            },
        ],
        context: ExperimentContext.Personal,
    ...
    },
    {
        ...
        components: [
            {
                architectures: [],
                description: 'Command center for agents and automations.',
                isPrivate: true,
                name: 'Forge',
                sourceUrl: new URL(`${REPOSITORY_BASE_URL}jterrazz-forge`),
                status: ExperimentStatus.Active,
            },
        ],
        context: ExperimentContext.Personal,
        description: 'Command center for autonomous AI agents and automations.',
        tagline: 'Autonomous AI workflows.',
        longDescription:
            'A command center for autonomous AI workflows. Agents that can browse the web, write code, manage files, and chain actions together, experimenting with how far LLMs can go when given tools and memory.',
        name: 'Forge',
        slug: 'forge',
        status: ExperimentStatus.Active,
        year: 2024,
