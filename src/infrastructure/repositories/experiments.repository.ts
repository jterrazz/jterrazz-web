...
const experiments: Experiment[] = [
  ...
  },
  {
    ...
    context: ExperimentContext.Personal,
    description: "Augmented news experience.",
    tagline: "Challenge your critical thinking.",
    hasPrivacyPolicy: true,
    iconUrl: "/assets/icons/appicon-n00.png",
    longDescription:
      "n00 is a playful application designed to challenge your critical thinking. It presents you with headlines generated by AI, and your task is to determine if they are real or fake. The system is built as a distributed application with a Hexagonal Architecture backend and a modern React Native frontend.",
    name: "n00",
    slug: "n00",
    status: ExperimentStatus.Active,
    storeLinks: {
  ...
  },
  {
    ...
    tagline: "Portfolio and digital garden.",
  ...
  },
  {
    ...
    longDescription:
      "An exploration of Quines—programs that output their own source code. This project challenges you to write self-replicating programs in C, Assembly, and other languages. It dives into Kleene's recursion theorem and the theoretical underpinnings of computer viruses and self-reproducing automata.",
    name: "Dr Quine",
    slug: "dr-quine",
    status: ExperimentStatus.Completed,
    year: 2019,
