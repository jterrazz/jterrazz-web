...
const experiments: Experiment[] = [
  ...
  },
  {
    ...
    context: ExperimentContext.Personal,
    description: "Real-time intelligence for a noisy world.",
    tagline: "Monitor global narratives as they evolve.",
    hasPrivacyPolicy: true,
    iconUrl: "/assets/icons/appicon-n00.png",
    longDescription:
      "n00 is a dashboard for monitoring global narratives in real-time. AI distills signal from noise, mapping where stories align, clash, and fade into speculation—helping you understand the world beyond headlines.",
    name: "n00",
    slug: "n00",
    status: ExperimentStatus.Active,
    storeLinks: {
