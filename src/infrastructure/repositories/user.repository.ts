...
const contacts: Record<UserContactType, UserContact> = {
    ...
    [UserContactType.Twitter]: {
        ...
        url: new URL('https://twitter.com/jterrazzx'),
        value: '@jterrazzx',
    },
    ...
    [UserContactType.X]: {
        ...
        url: new URL('https://x.com/jterrazzx'),
        value: '@jterrazzx',
    },
};
...
const experiences: UserExperience[] = [
    ...
    {
        description:
            'Engineering secure open banking infrastructure. Modernizing legacy systems with Node.js, TypeScript, and rigorous TDD practices.',
        location: 'France',
        organization: 'Bridge',
        organizationUrl: 'https://bridgeapi.io/',
    ...
    {
        description:
            'Built backend services for a personal finance app used by millions. Node.js, TypeScript, and a strong testing culture.',
        location: 'France',
        organization: 'Bankin',
        organizationUrl: 'https://bankin.com/',
        timeframe: 'Avril 2020 - 2022',
        title: 'Backend Developer',
        type: 'Job',
        year: '2020',
    },
