...
export const ArticleTemplate: React.FC<ArticleTemplateProps> = ({
  ...
  return (
    <Container className="mt-6 md:mt-10 relative">
      ...
      {linkedExperiment && (
        <Link
          className="group flex items-center gap-2 mb-6 px-3 py-2 -mx-3 rounded-lg text-sm text-zinc-500 dark:text-zinc-400 hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-colors"
