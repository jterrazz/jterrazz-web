...
const LEAD_STYLES: Record<NonNullable<LeadProps['size']>, string> = {
    lg: 'text-base md:text-lg text-zinc-600 dark:text-zinc-400 text-pretty max-w-2xl',
    md: 'text-sm md:text-base text-zinc-600 dark:text-zinc-400 text-pretty max-w-2xl',
    sm: 'text-sm text-zinc-500 dark:text-zinc-400 text-pretty',
};
