              ...
              <AnimatePresence initial={false}>
                {headings.map((heading, index) => {
                  ...
                  if (!isActiveOrAncestorActive) {
                    ...
                    if (activeIndex !== -1) {
                      ...
                      while (checkIndex >= 0) {
                        ...
                        if (checkHeading.level < headings[activeIndex].level) {
                  ...
                  if (isTopLevel) {
                    ...
                    const parentHeadingIndex = headings.findIndex((h) => h.id === parentId);
                    ...
                    if (parentHeadingIndex !== -1) {
                      ...
                      if (activeId === parentId) {
                        ...
                        if (activeIndex > parentHeadingIndex) {
                          ...
                          for (let k = parentHeadingIndex + 1; k < headings.length; k++) {
                            if (headings[k].level <= headings[parentHeadingIndex].level) {
                              nextSiblingIndex = k;
                              break;
                            }
                          }
                      ...
                      if (isInsideParentScope) {
                        showBasedOnParent = true;
                      }
                    }
                  }

                  if (!showBasedOnParent) {
                    return null;
                  }
