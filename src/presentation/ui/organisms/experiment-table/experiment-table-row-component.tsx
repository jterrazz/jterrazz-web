    ...
    >
      ...
      >
        ...
        <div className="flex items-start justify-between mb-3">
          <h3 className="font-bold text-lg text-zinc-900 dark:text-zinc-100">{component.name}</h3>
        ...
        <div className="mt-auto pt-4 flex items-center justify-between border-t border-zinc-100 dark:border-zinc-800/50">
          ...
          <div className="flex items-center gap-1.5">
            ...
            {hiddenTagsCount > 0 && (
              <span className="text-[10px] text-zinc-400 font-medium ml-1">+{hiddenTagsCount}</span>
            )}
          </div>
