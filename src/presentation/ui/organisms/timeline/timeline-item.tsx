...
export const TimelineItem: React.FC<TimelineItemProps> = ({ className, experience, index }) => {
    ...
    >
      ...
      <div
        className={cn(
          "relative group",
          "pl-16",
          isEven ? "md:text-right md:pr-16 md:pl-0" : "md:col-start-2 md:pl-16 md:text-left",
        )}
      >
              ...
              <div className="w-full">
                ...
                >
                  ...
                  <div className="flex items-center gap-1.5">
                    <IconMapPinFilled className="text-zinc-400 dark:text-zinc-500" size={14} />
